...
contract ConditionalTransferModule is AbstractModule {
     ...
     */
    function isTransferApproved(address _compliance, bytes32 _transferHash) public view onlyBoundCompliance(_compliance) returns (bool) {
     ...
     *  requires `_compliance` to be bound to this module
     */
    function getTransferApprovals(address _compliance, bytes32 _transferHash) public view onlyBoundCompliance(_compliance) returns (uint256) {
